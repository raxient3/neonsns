...
class Upload_List extends Field {
	...
	public function render_control() {
		$images = $this->get_field_value( 'id' );
		?>
			...
			<div class="xts-upload-btns">
				...
				<button class="xts-btn xts-clear-all"><?php esc_html_e( 'Clear all', 'xts-theme' ); ?></button>
				<input type="hidden" class="xts-upoad-input-id" name="<?php echo esc_attr( $this->get_input_name( 'id' ) ); ?>" value="<?php echo esc_attr( $images ); ?>" />
			</div>
		<?php
	}
