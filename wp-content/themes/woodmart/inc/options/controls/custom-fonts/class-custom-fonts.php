		...
		?>
			<div class="xts-custom-fonts-field xts-upload-control">
				...
				<div class="xts-upload-btns">
					...
					<input type="hidden" class="xts-upoad-input-url" name="<?php echo esc_attr( $name . '[url]' ); ?>" value="<?php echo esc_attr( $values['url'] ); ?>" />
					<input type="hidden" class="xts-upoad-input-id" name="<?php echo esc_attr( $name . '[id]' ); ?>" value="<?php echo esc_attr( $values['id'] ); ?>" />
				</div>
			</div>
		<?php
	}
