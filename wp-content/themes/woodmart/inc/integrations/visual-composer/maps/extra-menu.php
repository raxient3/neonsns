			...
			'params' => array(
				...
				*/
				...
				array(
					...
					'style' => array(
						'primary' => woodmart_get_opt( 'primary-color' ) ? woodmart_get_opt( 'primary-color' )['idle'] : '#7eb934',
						'secondary' => woodmart_get_opt( 'secondary-color' ) ? woodmart_get_opt( 'secondary-color' )['idle'] : '#fbbc34',
						'red' => '#D41212',
						'green' => '#65B32E',
						'blue' => '#00A1BE',
						'orange' => '#fbbc34',
